...
steps:
  ...
  fracture-of-wrist-unspecified---primary:
    run: fracture-of-wrist-unspecified---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  fracture-of-wrist-forearm---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: fracture-of-wrist-unspecified---primary/output
